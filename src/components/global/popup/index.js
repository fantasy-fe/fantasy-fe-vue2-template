...
export default {
  ...
  methods: {
    ...
    doOpen (props) {
      ...
      // 如果message是vue模板传element
      if (typeof props.message === 'object') {
        var content = dom.querySelector('.msgbox-message').innerHTML
        if (content) dom.querySelector('.msgbox-message').innerHTML = ''
        dom.querySelector('.msgbox-message').appendChild(props.message)
      }
